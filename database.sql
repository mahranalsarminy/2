...
--
-- Host: localhost:3306
-- Generation Time: 11 مارس 2025 الساعة 21:22
-- إصدار الخادم: 8.0.41
-- PHP Version: 8.3.15
...
INSERT INTO `admins` (`id`, `firstname`, `lastname`, `email`, `avatar`, `password`, `google2fa_status`, `google2fa_secret`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 'Admin', 'Admin', 'admin@gmail.com', 'images/avatars/default.png', '123456', 0, NULL, 'FQxgha1pEyBPtKqlYyJOU33MxFCC83Oo4BYzCKMKCSuLeWrkJJKOv1d6NaMk', '2025-03-11 15:15:05', '2025-03-11 15:15:05');
...
--
-- إرجاع أو استيراد بيانات الجدول `captcha_providers`
--
...
CREATE TABLE `engines` (
  ...
  `sizes` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `art_styles` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `lightning_styles` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `moods` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
--
-- إرجاع أو استيراد بيانات الجدول `extensions`
--
...
--
-- إرجاع أو استيراد بيانات الجدول `footer_menu`
--
...
CREATE TABLE `generated_images` (
  ...
  `art_style` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `lightning_style` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- إرجاع أو استيراد بيانات الجدول `mail_templates`
--
...
--
-- إرجاع أو استيراد بيانات الجدول `navbar_menu`
--
...
--
-- إرجاع أو استيراد بيانات الجدول `oauth_providers`
--
...
CREATE TABLE `plans` (
  ...
  `engines` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
--
-- بنية الجدول `seo_configurations`
--
...
(1, 'general', '{\"site_name\":\"WallPix\",\"site_url\":\"https:\\/\\/wallpix.se\",\"contact_email\":\"\",\"terms_of_service_link\":\"\\/\",\"date_format\":\"10\",\"timezone\":\"America\\/New_York\"}'),
...
--
-- إرجاع أو استيراد بيانات الجدول `storage_providers`
--
...
--
-- قيود الجداول `seo_configurations`
--
ALTER TABLE `seo_configurations`
